...
@WebServlet("/boardWrite.in")
public class boardgroupInsertServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public boardgroupInsertServlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result = new BoardService().insertFreeBoard(board); //insertPlayGroup
